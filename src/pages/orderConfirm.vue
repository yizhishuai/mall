      ...
      <template v-slot:body>
        <div class="edit-wrap">
          <div class="item">
            ...
            <input type="text" class="input" placeholder="请输入11位手机号" v-model="checkItem.receiverMobile" />
        ...
        <!-- <div class="">{{address}}</div> -->
          ...
          <div class="item">
            <input type="text" class="input" placeholder="请输入6位邮编" v-model="checkItem.receiverZip" />
          </div>
        </div>
        </div>
      </template>
...
import addressPicker from './../components/vue-address-picker'
export default {
  name: "order-confirm",
  components: {
    OrderHeader,
    ...
    submitAddr() {
      ...
      if (userAction == 0 || userAction == 1) {
        ...
        let {
          ...
          receiverDistrict=this.address.city,
          receiverAddress,
          receiverZip
        } = checkItem;
        if (!receiverName) {
